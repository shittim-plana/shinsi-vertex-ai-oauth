// // @typscript-eslint/no-require-imports
// const admin = require('firebase-admin');
// // FieldValue는 admin.firestore 객체를 통해 접근합니다.
...
// // @typscript-eslint/no-require-imports
// const serviceAccount = require('../../arona-mk-2-firebase-adminsdk-fbsvc-77389f5402.json');
...
//   });
// } catch (error) {
//   // 오류 객체이고 code 속성이 있는지 확인 후 접근합니다.
//   if (typeof error === 'object' && error !== null && 'code' in error && error.code !== 'app/duplicate-app') {
//     console.error('Firebase Admin initialization error:', error);
//     process.exit(1);
//   } else if (typeof error === 'object' && error !== null && 'code' in error && error.code === 'app/duplicate-app') {
...
//         messages: FieldValue.delete() // admin.firestore.FieldValue 사용
//       });
//       operationCount++;
//       migratedCount++;
